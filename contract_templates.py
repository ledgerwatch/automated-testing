    ...
    def compile_contract(contract_path):
        def compile_source_file():
            ...
            with open(contracts_path + contract_path, 'r', encoding='utf-8') as f:
                return solcx.compile_source(f.read(), output_values=["abi", "bin"], solc_version="0.8.13")

        contract_interface = compile_source_file()['<stdin>:MySimpleToken']  # Compiled source code
